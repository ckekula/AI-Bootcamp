...
def main():
    ...
    list_parser = ___()  # Replace ___ with: CommaSeparatedListOutputParser
    ...
    json_chain = ___ | ___ | ___  # Replace ___ with: json_prompt, llm, json_parser
    ...
    if json_chain:
        ...
        try:
            ...
            parsed = result # already a dict from json_parser!
